!(function (a) {
  var b = {
    ...
    controls: !0,
    nextText:
      "<i class='fa fa-circle text-purple text-center'></i> <i class='fa fa-circle text-purple text-center mr-2'></i>",
    prevText: "<i class='fa fa-circle text-purple text-center'></i> ",
    nextSelector: null,
    prevSelector: null,
    autoControls: !1,
    startText: "Start",
